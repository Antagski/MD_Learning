...
def find_unit_line_number(file_path, unit_header):
    ...
    try:
        # Attempt to read the line number from a stored file (optional, based on your implementation)
        with open('unit_line_number.txt', 'r') as f:
    ...
    # 储存备用
    with open('unit_line_number.txt', 'w') as f:
